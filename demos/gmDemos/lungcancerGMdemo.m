...
CPD{S} = createTabularFactor(reshape([0.8 0.2], 2, 1), [S]);
CPD{CB} = createTabularFactor(reshape([0.95 0.75  0.05 0.25], 2, 2), [S CB]);
CPD{LC} = createTabularFactor(reshape([0.99995 0.997 0.00005 0.003], 2, 2), [S LC]);
%CPD{SOB} = createTabularFactor(reshape([0.95 0.9 0.5 0.25  0.05 0.1 0.5 0.75], 2, 2, 2), [CB LC SOB]);
CPD{SOB} = createTabularFactor(reshape([0.95 0.5 0.5 0.25  0.05 0.5 0.5 0.75], 2, 2, 2), [CB LC SOB]);
CPD{X} = createTabularFactor(reshape([0.98 0.4 0.02 0.6], 2, 2), [LC X]);
...
fac{1} = createTabularFactor(ones(2,2,2), [S, CB, LC]);
