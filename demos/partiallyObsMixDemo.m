% This is similar to noisyMixDemo except
% the model has the form
% Yj <- Z -> Xj
% Z is mixture node
% Xj is binary tag
% Yj is cts response of tag detector

% By discretizing Yj we get a regular discrete mixture model
% where Xj is binary, Yk is V-ary
% Alternatively we can use a gaussian for Yj
