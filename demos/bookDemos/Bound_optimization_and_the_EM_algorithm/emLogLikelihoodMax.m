...
f3 = @(x) 5*sin(2*(x-0.5))                      + ...
         ...
         f2(0.5*x)                              + ...
         3.5                                    + ...
         20  * gausspdf(x, -2    , 0.5.^2)'     - ...
         20  * gausspdf(x,  3    , 1.^2  )'     - ...
         70  * gausspdf(x,  4    , 0.5.^2)'     + ...
         40  * gausspdf(x, -3    , 0.5.^2)'     + ...
         100 * gausspdf(x, -4    , 0.8.^2)'     + ...
         10  * gausspdf(x,  3    , 0.3.^2)'     - ...
         10  * gausspdf(x, -2.8  , 0.5.^2)';
...
box on;
set(gca, 'XTick', [], 'YTick', []);
legend([p1, p2, p3], {'Q(\theta,\theta_k)','Q(\theta,\theta_{k+1})','ln p(x | \theta)'}, ...
