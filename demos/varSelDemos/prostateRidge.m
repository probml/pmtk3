%% L2 linear regression with cross validation on the prostate data set 
% Reproduce fig 3.6 on p58 of "Elements of statistical learning" 
load prostate
includeOffset = true;
fitFn     = @(X, y, lambda)linregL2Fit(X, y, lambda, includeOffset);
...
title(sprintf('ridge, mseTest = %5.3f', lossFn(yhat, ytest)));
printPmtkFigure prostateRidgeCV