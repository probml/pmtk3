...
tableData = {'S' , 'stats toolbox needed',           'M' , 'matlab needed, (will not work in octave)'
             'B' , 'bioinformatics toolbox needed',  'I' , 'interactive'
             'O' , 'optimization toolbox needed',    '*' , 'slow (two stars indicates very slow)'
             };
