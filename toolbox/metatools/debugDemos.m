...
fprintf('%d out of %d failed\n', numel(fieldnames(errors)), ndemos + numel(excluded));
fprintf('%d out of %d have warnings\n', numel(fieldnames(warnings)), ndemos + numel(excluded));
fprintf('%d out of %d were skipped\n', numel(excluded), ndemos + numel(excluded));
nKnownBroken = 0;
