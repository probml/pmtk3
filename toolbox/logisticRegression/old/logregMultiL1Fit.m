function wSoftmax = logregMultiL1Fit(X,y, lambda, addOnes, nClasses)
% Find MAP estimate for multinomial logistic regression using L1 prior
...
[wSoftmax] = minFunc(@penalizedL1, winit(:), options, funObj, lambda(:));
