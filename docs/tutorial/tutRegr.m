%% Regression using discriminative models in pmtk3
...
% to 1d data. We then compute the mean
...
% If we use a uniform prior, we can focus on the
...
%% EB and VB for nonlinear regression
% Obviously we can combine EB and VB with basis function
% expansion to fit nonlinear models in a Bayesian way.
