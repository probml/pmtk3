...
%#author Schniter and Ziniel
%#url http://www.ece.osu.edu/~zinielj/fbmp/pubs.html
...
[init, other] = process_options(varargin, 'init', 'lars');
switch init
  case 'schniter'
    p1_est = 0.10;
    sig2w_est = 0.05;
...
[p1, sig2w, sig2s, mus, D, stop, maxSearchDepth, other] = process_options(varargin, ...
  'p1', p1_est, 'sig2w', sig2w_est, 'sig2s', [0 ;sig2s_est], ...
...
[P, other] = process_options(varargin, 'searchDepth', P);
