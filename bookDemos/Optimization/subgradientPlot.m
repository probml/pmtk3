...
annotation(gcf,'doublearrow',rel2absX([1.3,1.3]),rel2absY([0.3,0.74]),'LineWidth',2);
annotation(gcf,'doublearrow',rel2absX([1.1,1.1]),rel2absY([0.3,f1(1.1)]),'HeadLength',3,'LineWidth',2);


maximizeFigure;
if doPrintPmtk, printPmtkFigures('subgradient'); end;
